...
export default function Alert({ type = "success", content, handleClick }) {
    switch (type) {
        case "success":
            return (
                <div
                    id="success-alert"
                    class="flex p-4 mb-4 border-t-4 rounded-md border-green-500 bg-green-200"
                    role="alert"
                >
                    <svg
                    ...
                    <button
                        onClick={handleClick}
                        type="button"
                        class="ml-auto mx-2 -my-1.5 bg-green-200 text-green-500 rounded-lg focus:ring-2 focus:ring-green-400 p-1.5 hover:bg-green-200 dark:hover:bg-green-300 inline-flex h-8 w-8"
